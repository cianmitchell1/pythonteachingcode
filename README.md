...
> COMING SOON
8. Python Coding Project
> Checkers, this game is created using PyGame anf the tutoirial with TechwitTim. Checkers is one of the oldest one on one games in the world, so universal that almost everyone in the world knows how to use it. 
.
